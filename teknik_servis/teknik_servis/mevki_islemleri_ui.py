...
# Form implementation generated from reading ui file 'mevki_islemleri_ui.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.mevki_adi = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.mevki_adi.setObjectName("mevki_adi")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.mevki_adi)
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Mevki Adı"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Güncelle"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Sil"))
        self.birimAdNGirinizLabel.setText(_translate("Form", "Mevki Adını Giriniz"))
        self.pushButton.setText(_translate("Form", "Yeni Mevki Kaydet"))
