...
# Form implementation generated from reading ui file 'durum_islemleri_ui.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.durum_adi = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.durum_adi.setObjectName("durum_adi")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.durum_adi)
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Durum Adı"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Güncelle"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Sil"))
        self.birimAdNGirinizLabel.setText(_translate("Form", "Durum Adını Giriniz"))
        self.pushButton.setText(_translate("Form", "Yeni Durum Kaydet"))
