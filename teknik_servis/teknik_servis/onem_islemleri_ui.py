...
# Form implementation generated from reading ui file 'onem_islemleri_ui.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.onem_adi = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.onem_adi.setObjectName("onem_adi")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.onem_adi)
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Önem Adı"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Güncelle"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Sil"))
        self.birimAdNGirinizLabel.setText(_translate("Form", "Önem Adını Giriniz"))
        self.pushButton.setText(_translate("Form", "Yeni Önem Kaydet"))
